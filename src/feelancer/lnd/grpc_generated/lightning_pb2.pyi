...
class _CommitmentTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_CommitmentType.ValueType], builtins.type):
    ...
    """
    SIMPLE_TAPROOT_OVERLAY: _CommitmentType.ValueType  # 6
    """
...
features where relevant.
"""
SIMPLE_TAPROOT_OVERLAY: CommitmentType.ValueType  # 6
"""
Identical to the SIMPLE_TAPROOT channel type, but with extra functionality.
This channel type also commits to additional meta data in the tapscript
leaves for the scripts in a channel.
...
class _PaymentFailureReasonEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_PaymentFailureReason.ValueType], builtins.type):
    ...
    """
    FAILURE_REASON_CANCELED: _PaymentFailureReason.ValueType  # 6
    """
...
Insufficient local balance.
"""
FAILURE_REASON_CANCELED: PaymentFailureReason.ValueType  # 6
"""
The payment was canceled.
"""
...
class SendCoinsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["addr", b"addr", "amount", b"amount", "coin_selection_strategy", b"coin_selection_strategy", "label", b"label", "min_confs", b"min_confs", "outpoints", b"outpoints", "sat_per_byte", b"sat_per_byte", "sat_per_vbyte", b"sat_per_vbyte", "send_all", b"send_all", "spend_unconfirmed", b"spend_unconfirmed", "target_conf", b"target_conf"]) -> None: ...
...
class Channel(google.protobuf.message.Message):
    ...
    CUSTOM_CHANNEL_DATA_FIELD_NUMBER: builtins.int
    ...
    """
    custom_channel_data: builtins.bytes
    """
...
@typing.final
class CloseOutput(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def ClearField(self, field_name: typing.Literal["amount_sat", b"amount_sat", "custom_channel_data", b"custom_channel_data", "is_local", b"is_local", "pk_script", b"pk_script"]) -> None: ...

global___CloseOutput = CloseOutput
...
class ChannelCloseUpdate(google.protobuf.message.Message):
    ...
    LOCAL_CLOSE_OUTPUT_FIELD_NUMBER: builtins.int
    REMOTE_CLOSE_OUTPUT_FIELD_NUMBER: builtins.int
    ADDITIONAL_OUTPUTS_FIELD_NUMBER: builtins.int
    closing_txid: builtins.bytes
    success: builtins.bool
    @property
    def local_close_output(self) -> global___CloseOutput:
        """The local channel close output. If the local channel balance was dust to
        begin with, this output will not be set.
        """

    @property
    def remote_close_output(self) -> global___CloseOutput:
        """The remote channel close output. If the remote channel balance was dust
        to begin with, this output will not be set.
        """

    @property
    def additional_outputs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___CloseOutput]:
    ...
    def __init__(
        ...
        *,
        closing_txid: builtins.bytes = ...,
        success: builtins.bool = ...,
        local_close_output: global___CloseOutput | None = ...,
        remote_close_output: global___CloseOutput | None = ...,
        additional_outputs: collections.abc.Iterable[global___CloseOutput] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["local_close_output", b"local_close_output", "remote_close_output", b"remote_close_output"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["additional_outputs", b"additional_outputs", "closing_txid", b"closing_txid", "local_close_output", b"local_close_output", "remote_close_output", b"remote_close_output", "success", b"success"]) -> None: ...
...
class Route(google.protobuf.message.Message):
    ...
    TOTAL_AMT_MSAT_FIELD_NUMBER: builtins.int
    FIRST_HOP_AMOUNT_MSAT_FIELD_NUMBER: builtins.int
    CUSTOM_CHANNEL_DATA_FIELD_NUMBER: builtins.int
    ...
    """
    first_hop_amount_msat: builtins.int
    """
    ...
    def ClearField(self, field_name: typing.Literal["custom_channel_data", b"custom_channel_data", "first_hop_amount_msat", b"first_hop_amount_msat", "hops", b"hops", "total_amt", b"total_amt", "total_amt_msat", b"total_amt_msat", "total_fees", b"total_fees", "total_fees_msat", b"total_fees_msat", "total_time_lock", b"total_time_lock"]) -> None: ...
...
class Invoice(google.protobuf.message.Message):
    ...
    IS_BLINDED_FIELD_NUMBER: builtins.int
    BLINDED_PATH_CONFIG_FIELD_NUMBER: builtins.int
    memo: builtins.str
    """
    ...
    @property
    def blinded_path_config(self) -> global___BlindedPathConfig:
        """
    ...
    def __init__(
        ...
        *,
        ...
        is_blinded: builtins.bool = ...,
        blinded_path_config: global___BlindedPathConfig | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["blinded_path_config", b"blinded_path_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["add_index", b"add_index", "amp_invoice_state", b"amp_invoice_state", "amt_paid", b"amt_paid", "amt_paid_msat", b"amt_paid_msat", "amt_paid_sat", b"amt_paid_sat", "blinded_path_config", b"blinded_path_config", "cltv_expiry", b"cltv_expiry", "creation_date", b"creation_date", "description_hash", b"description_hash", "expiry", b"expiry", "fallback_addr", b"fallback_addr", "features", b"features", "htlcs", b"htlcs", "is_amp", b"is_amp", "is_blinded", b"is_blinded", "is_keysend", b"is_keysend", "memo", b"memo", "payment_addr", b"payment_addr", "payment_request", b"payment_request", "private", b"private", "r_hash", b"r_hash", "r_preimage", b"r_preimage", "route_hints", b"route_hints", "settle_date", b"settle_date", "settle_index", b"settle_index", "settled", b"settled", "state", b"state", "value", b"value", "value_msat", b"value_msat"]) -> None: ...

global___Invoice = Invoice

@typing.final
class BlindedPathConfig(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    MIN_NUM_REAL_HOPS_FIELD_NUMBER: builtins.int
    NUM_HOPS_FIELD_NUMBER: builtins.int
    MAX_NUM_PATHS_FIELD_NUMBER: builtins.int
    NODE_OMISSION_LIST_FIELD_NUMBER: builtins.int
    min_num_real_hops: builtins.int
    """
    ...
    """
    max_num_paths: builtins.int
    """
    The maximum number of blinded paths to select and add to an invoice.
    """
    @property
    def node_omission_list(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.bytes]:
        """
    ...
    def __init__(
        self,
        *,
        min_num_real_hops: builtins.int | None = ...,
        num_hops: builtins.int | None = ...,
        max_num_paths: builtins.int | None = ...,
        node_omission_list: collections.abc.Iterable[builtins.bytes] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["_max_num_paths", b"_max_num_paths", "_min_num_real_hops", b"_min_num_real_hops", "_num_hops", b"_num_hops", "max_num_paths", b"max_num_paths", "min_num_real_hops", b"min_num_real_hops", "num_hops", b"num_hops"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_max_num_paths", b"_max_num_paths", "_min_num_real_hops", b"_min_num_real_hops", "_num_hops", b"_num_hops", "max_num_paths", b"max_num_paths", "min_num_real_hops", b"min_num_real_hops", "node_omission_list", b"node_omission_list", "num_hops", b"num_hops"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_max_num_paths", b"_max_num_paths"]) -> typing.Literal["max_num_paths"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_min_num_real_hops", b"_min_num_real_hops"]) -> typing.Literal["min_num_real_hops"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_num_hops", b"_num_hops"]) -> typing.Literal["num_hops"] | None: ...

global___BlindedPathConfig = BlindedPathConfig
...
class InvoiceHTLC(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["accept_height", b"accept_height", "accept_time", b"accept_time", "amp", b"amp", "amt_msat", b"amt_msat", "chan_id", b"chan_id", "custom_channel_data", b"custom_channel_data", "custom_records", b"custom_records", "expiry_height", b"expiry_height", "htlc_index", b"htlc_index", "mpp_total_amt_msat", b"mpp_total_amt_msat", "resolve_time", b"resolve_time", "state", b"state"]) -> None: ...
...
class PolicyUpdateRequest(google.protobuf.message.Message):
    ...
    CREATE_MISSING_EDGE_FIELD_NUMBER: builtins.int
    base_fee_msat: builtins.int
    """The base fee charged regardless of the number of milli-satoshis sent."""
    fee_rate: builtins.float
    ...
    create_missing_edge: builtins.bool
    ...
    def ClearField(self, field_name: typing.Literal["base_fee_msat", b"base_fee_msat", "chan_point", b"chan_point", "create_missing_edge", b"create_missing_edge", "fee_rate", b"fee_rate", "fee_rate_ppm", b"fee_rate_ppm", "global", b"global", "inbound_fee", b"inbound_fee", "max_htlc_msat", b"max_htlc_msat", "min_htlc_msat", b"min_htlc_msat", "min_htlc_msat_specified", b"min_htlc_msat_specified", "scope", b"scope", "time_lock_delta", b"time_lock_delta"]) -> None: ...
