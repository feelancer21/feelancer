...
# class HtlcFailureSourceType(PyEnum):
#     UNKNOWN = 0
#     INCOMING = 1
#     OUTGOING = 2


# class HtlcFailInfo(Base):
#     """
#     The local failure source does not necessarily have to be the channel of the
#     failed htlc, but can be another linked channel, e.g. in the case of a forward.
#     """

#     __tablename__ = "ln_htlc_fail_info"
...
#     # Indicates if the failure was on the incoming or outgoing side.
#     failure_source_type: Mapped[HtlcFailureSourceType] = mapped_column(
#         Enum(HtlcFailureSourceType), nullable=False
#     )

#     channel_id_source: Mapped[str] = mapped_column(String, nullable=False, index=True)
